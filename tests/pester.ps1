...
Remove-Module PSTranslate -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PSTranslate\PSTranslate.psd1"
Import-Module "$PSScriptRoot\..\PSTranslate\PSTranslate.psm1" -Force
