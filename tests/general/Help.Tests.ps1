...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\PSTranslate\functions", "$global:testroot\..\PSTranslate\internal\functions"),
	
	[string]
	$ModuleName = "PSTranslate",
...
$CommandPath = @(
    "$global:testroot\..\PSTranslate\functions"
    "$global:testroot\..\PSTranslate\internal\functions"
)
